...
import cl.visionary.shrinkquizz.data.MatchResult;
...
public class MatchFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //Find de textview for the lover y Seekbar for the lover
        ...
        //set a change listener for th seekbar
    ...
    private void showResult(int ageUser, int ageLover){
        new AlertDialog.Builder(getActivity())
                .setTitle("Son una pareja ¿¿¿'??¡'¡?¡")
                .setMessage(new MatchResult(ageUser, ageLover).result())
                .show();
    }
}
